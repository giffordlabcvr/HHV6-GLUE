...
var ns_fasta_aa_str = ns_fasta_aa.join("\n");
glue.command(["file-util", "save-string", ns_fasta_aa_str, "export/ns_fasta.faa"]);
var ns_fasta_nt_str = ns_fasta_nt.join("\n");
glue.command(["file-util", "save-string", ns_fasta_nt_str, "export/ns_fasta.fna"]);

var vp_fasta_aa_str = vp_fasta_aa.join("\n");
glue.command(["file-util", "save-string", vp_fasta_aa_str, "export/vp_fasta.faa"]);
var vp_fasta_nt_str = vp_fasta_nt.join("\n");
glue.command(["file-util", "save-string", vp_fasta_nt_str, "export/vp_fasta.fna"]);
...
function create_feature_fasta(refseqID, featureID, featureCodons, featureSummary) {
	...
	if (featureID == "NS") {
	  ns_fasta_aa.push(fasta_aa); 
	  ns_fasta_nt.push(fasta_codons);
	
	}	
	
	if (featureID == "VP") {
	  vp_fasta_aa.push(fasta_aa); 
	  vp_fasta_nt.push(fasta_codons);
	}	
